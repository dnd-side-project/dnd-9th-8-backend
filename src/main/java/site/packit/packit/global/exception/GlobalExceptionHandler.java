...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler
    protected ResponseEntity<ErrorApiResponse> handleHttpRequestMethodNotSupportedException(
            HttpRequestMethodNotSupportedException e
    ) {
        log.error("[handle HttpRequestMethodNotSupportedException] - {}", INVALID_REQUEST_METHOD.getMessage());
        return new ResponseEntity<>(
                ErrorApiResponse.of(INVALID_REQUEST_METHOD),
    ...
    @ExceptionHandler
    protected ResponseEntity<ErrorApiResponse> handleException(
            Exception e
    ) {
        log.error("[handle Exception] - {}", e.getMessage());
        return new ResponseEntity<>(
                ErrorApiResponse.of(SERVER_ERROR),
